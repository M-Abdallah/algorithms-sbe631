...
def __traceback__(seqX, seqY):
    ...
    if j == 0:
        ...
        jMid = np.argmax( sum )
        alignedPair+= __traceback__ ( seqX[0:iMid], seqY[ 0: jMid ] )
        alignedPair+= __traceback__ ( seqX[iMid:i], seqY[ jMid: j ] )  
...
if __name__ == "__main__":
    ...
    aligned = __traceback__( seq1, seq2 )
    # print(aligned)
    # aligned.reverse()
    # print(aligned)
